            ...
            >
              ...
              >
                {domain.icon ? (
                  ...
                  <div className="w-5 h-5 bg-primary rounded-sm flex items-center justify-center text-primary-foreground text-xs font-bold">
    ...
    const fetchUserPlan = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setCurrentPlan(
            (data.plan as "STARTER" | "GROWTH" | "PRO") || "STARTER"
          );
        }
      } catch (error) {
